...
public class DataWriteController
{
    ...
    public CommonMappedResult actionInsertProgram(@RequestBody @Valid ProgramData requestBody, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
